...
<style scoped>
.adopt-page { padding-bottom: 40rpx; }
.hero { display: flex; align-items: center; justify-content: space-between; gap: 24rpx; margin-bottom: 24rpx; }
.eyebrow { display: block; margin-bottom: 12rpx; color: #80b1a7; font-size: 24rpx; font-weight: 700; }
.title { display: block; color: #2f2a25; font-size: 42rpx; font-weight: 800; line-height: 1.2; }
.publish-btn { width: 164rpx; height: 68rpx; border-radius: 20rpx; background: #f08a5d; color: #fff; font-size: 26rpx; line-height: 68rpx; }
.search-box { display: flex; align-items: center; height: 88rpx; padding: 0 24rpx; margin-bottom: 24rpx; border-radius: 28rpx; background: #fff; box-shadow: 0 10rpx 30rpx rgba(90, 72, 54, 0.06); }
.search-icon { margin-right: 18rpx; color: #9d8f80; font-size: 24rpx; }
.search-box input { flex: 1; height: 88rpx; font-size: 28rpx; }
.placeholder { color: #b8afa5; }
.banner { height: 220rpx; margin-bottom: 24rpx; border-radius: 28rpx; overflow: hidden; }
.banner-card { height: 220rpx; padding: 34rpx; border-radius: 28rpx; background: linear-gradient(135deg, #f7c79b 0%, #80b1a7 100%); }
.banner-title { display: block; margin-bottom: 14rpx; color: #fff; font-size: 36rpx; font-weight: 800; }
...
.category-btn.active { background: #2f2a25; color: #fff; }
...
.pet-status { flex-shrink: 0; padding: 8rpx 14rpx; border-radius: 999rpx; background: #fff3dd; color: #a06528; font-size: 22rpx; }
